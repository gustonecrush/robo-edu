...
export default function Brands() {
    ...
    return (
        <section className="w-full h-fit px-3 md:px-20 justify-center py-5 flex-wrap flex gap-5 items-center">
            <Marquee speed={50}>  <Image
                ...
                className={'w-10 md:w-20 h-fit ml-5 md:ml-10'}
            />
                <Image
                    key={brands[1].name}
                    alt={brands[1].name}
                    ...
                    className={'w-16 md:w-32 h-fit ml-5 md:ml-10'}
                />
                <Image
                    key={brands[2].name}
                    alt={brands[2].name}
                    ...
                    className={'w-20 md:w-40 h-fit ml-5 md:ml-10'}
                />
                <Image
                    key={brands[3].name}
                    alt={brands[3].name}
                ...
                <Image
                    ...
                    className={'w-10 md:w-20 h-fit ml-10 md:ml-20'}
                />
                <Image
                    key={brands[5].name}
                    alt={brands[5].name}
                    ...
                    className={'w-24 md:56 h-fit ml-5 md:ml-10'}
                /></Marquee>
