...
function AboutSection() {
    return (
        <section className="w-full h-fit px-3 py-10 bg-white  z-50 flex items-center justify-center flex-col text-center gap-3">
            <h1 className='font-bold text-black text-2xl'>Visi & Misi Robo Edu</h1>
            <h2 className='text-secondColor'>Platform Pendukung  <br />Anak sTunagrahita</h2>
            <div className="flex flex-col gap-2 w-full">
                <Slide direction="left">
                    <div className="flex flex-col gap-2 border border-gray-300 rounded-lg px-4 py-5 shadow-md">
                        ...
                        <p className="text-sm text-justify">Menjadi E-Learning yang bermanfaat untuk anak disabilitas tunagrahita sedang dalam pengembangan pola pikir nya, khusus nya dalam materi CALISTUNG untuk mengejar keterlambatan berpikir dari anak normal.</p>
                    </div>
                </Slide>
                <Slide direction="right">
                    <div className="flex flex-col gap-2 border border-gray-300 rounded-lg px-4 py-5 shadow-md">
                        ...
                        <ol className="text-sm text-justify ml-3 list-decimal flex flex-col gap-2">
...
function MemberSection() {
    ...
    return (
        <section className="w-full h-fit px-3 py-10 bg-white  z-50 flex items-center justify-center flex-col text-center gap-3">
            <h1 className='font-bold text-black text-2xl'>Our Team</h1>
            <h2 className='text-secondColor'>Tim Dibalik <br />Platform Robo Edu</h2>
